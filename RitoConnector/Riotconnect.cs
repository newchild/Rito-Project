    ...
    internal class Riotconnect
    {
        ...
        public Riotconnect(string username, string region, string key)
        {
            ...
            var uri = "https://" + region.ToLower() + ".api.pvp.net/api/lol/" + region.ToLower() +
                      "/v1.4/summoner/by-name/" + username + "?api_key=" + key;
        ...
        {
            var url = "http://ddragon.leagueoflegends.com/cdn/4.21.5/img/profileicon/" + _user.ProfileIconId + ".png";
                // Needs update at every patch
            return url;
        }
